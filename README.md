This is the repository for the **NBMOD** (Noisy Background Multi-Object Dataset for grasp detection) and code of the paper ***NBMOD: Find It and Grasp It in Noisy Background***.
